    ...
    <>
      <div className="relative  hidden md:inline-block">
        <span
          ...
          className="flex items-center gap-2 hover:cursor-pointer text-black text-[15px] capitalize select-none"
        >
          {title}
        ...
        {isOpen && (
          <ul
            className={`absolute z-50 top-10  w-fit bg-white  ${
              mobview
                ? " min-w-[40vw] -left-10"
                : " min-w-[10vw] -left-5"
      ...
      <div className="relative flex w-full items-center justify-center sm:hidden">
        ...
        {isOpen && (
          <ul
            className={`absolute z-50 top-7  w-fit ${
              mobview
                ? "bg-white w-full "
